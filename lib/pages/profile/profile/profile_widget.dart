                            ...
                            children: [
                                ...
                                builder: (context) {
                                  if (loggedIn) {
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'PROFILE_PAGE_singin_ON_TAP');
                                        logFirebaseEvent('singin_navigate_to');
                              ...
                              if (loggedIn)
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_PAGE_UploadStoreTitle_ON_TAP');
                                    logFirebaseEvent(
                                        'UploadStoreTitle_navigate_to');

                                    context.pushNamed('UploadStore');
                                  },
                                  child: Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                              ...
                              if (loggedIn)
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_PAGE_TermsTitle_ON_TAP');
                                    logFirebaseEvent('TermsTitle_navigate_to');

                                    context.pushNamed('MyUploaedStore');
                                  },
                                  child: Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  await launchURL(
                                      'https://forms.gle/tQPPpYAyyxTYyCEf6');
                                },
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
