...
class OpenHoursStruct extends BaseStruct {
  OpenHoursStruct({
    String? monday,
    String? tuesday,
    String? wednesday,
  ...
  static OpenHoursStruct fromMap(Map<String, dynamic> data) => OpenHoursStruct(
  ...
  static OpenHoursStruct? maybeFromMap(dynamic data) => data is Map
      ? OpenHoursStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static OpenHoursStruct fromSerializableMap(Map<String, dynamic> data) =>
      OpenHoursStruct(
  ...
  @override
  String toString() => 'OpenHoursStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is OpenHoursStruct &&
        monday == other.monday &&
...
OpenHoursStruct createOpenHoursStruct({
  String? monday,
  String? tuesday,
  String? wednesday,
  String? thursday,
